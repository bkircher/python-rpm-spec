...
class Spec:
    ...
    @staticmethod
    def from_file(filename, initial=None):
    ...
    @staticmethod
    def from_string(string: str, initial=None):
...
def replace_macros(string, spec: typing.Dict[str, typing.Any]=None):
